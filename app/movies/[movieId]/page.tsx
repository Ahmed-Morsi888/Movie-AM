...
async function MovieId({params}: MovId) {
  ...
  const reviews = await fetch(`https://api.themoviedb.org/3/movie/${params.movieId}/reviews?api_key=a5c13fc09b1950b338b046e79ea8e6b1`);
...
<div className='w-full h-full  bg-gray-900 pt-4 pb-4 px-4 gap-4'>
  <div className='flex w-full flex-col  md:flex-row md:mx-auto min-h-[26rem]  md:justify-between md:items-center  md:gap-4 '>
      <div className='flex flex-col px-2  h-full w-full  md:w-1/4 xl:p '>
